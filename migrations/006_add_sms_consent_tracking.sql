...
ALTER TABLE customers ADD COLUMN IF NOT EXISTS sms_consent_ip VARCHAR(45); -- IPv6 support
ALTER TABLE customers ADD COLUMN IF NOT EXISTS sms_consent_version VARCHAR(20); -- v1, v2, etc.
ALTER TABLE customers ADD COLUMN IF NOT EXISTS sms_consent_source VARCHAR(100); -- 'website_onboarding', 'mobile_app', etc.
ALTER TABLE customers ADD COLUMN IF NOT EXISTS sms_consent_user_agent TEXT;

-- Create SMS consent audit table for detailed logging
...
-- Trigger for updated_at on audit table
