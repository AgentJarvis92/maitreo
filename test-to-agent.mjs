    ...
    <div class="email-wrapper">
        ...
        <main>
            ...
            <div class="mb-14">
                ...
                <a href="${stripePortalUrl}" class="subscription-link">Manage or cancel your subscription →</a>
            </div>
...
(async () => {
  try {
    const result = await resend.emails.send({
      ...
      to: 'agentjarvis@icloud.com',
      subject: 'Maitreo is now active for Test Restaurant',
      html,
    });
    console.log('✅ Test email sent to agentjarvis@icloud.com');
