...
export async function handleIncomingSMS(
  from: string,
  body: string
): Promise<{ action: 'approve' | 'edit' | 'skip' | 'unknown'; reviewId: string | null; responseText: string }> {
 ...
 */
export function getPendingApproval(phone: string): PendingApproval | undefined {
