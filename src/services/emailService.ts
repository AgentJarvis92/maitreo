...
<tr><td style="padding: 12px 0; font-family: 'Courier New', monospace; font-size: 11px; font-weight: 700; color: #1a1a1a; border-bottom: 1px solid #f0f0f0;">COMPETITOR SCAN</td><td style="padding: 12px 0 12px 24px; font-size: 13px; color: #666; border-bottom: 1px solid #f0f0f0;">Discover nearby competitors</td></tr>
