 ...
 */
function detectEscalation(review: Review): { hasEscalation: boolean; reasons: EscalationReason[] } {
  ...
  const keywordMap: Record<string, EscalationReason> = {
    'health': 'health_issue',
...
Write a reply to this review.`;
    ...
    console.error(`  ⚠️  [GPT-4o] API error: ${(error as Error).message}`);
