...
const server = http.createServer(async (req, res) => {
    ...
    if (url.pathname === '/onboarding/stripe/create-session' && req.method === 'POST') {
        try {
            ...
            const email = (_a = restaurant.rows[0]) === null || _a === void 0 ? void 0 : _a.owner_email;
    ...
    if (url.pathname === '/onboarding/complete' && req.method === 'POST') {
        try {
            ...
            if (restaurant === null || restaurant === void 0 ? void 0 : restaurant.owner_phone) {
                try {
    ...
    if (url.pathname === '/auth/google/callback' && req.method === 'GET') {
        ...
        try {
            ...
            if (result.success) {
                ...
                const returnUrl = rid && (returnUrls === null || returnUrls === void 0 ? void 0 : returnUrls.get(rid));
                if (returnUrl) {
